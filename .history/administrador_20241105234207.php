...
<body>
					...
					<div class="iniciar-sesion">
						...
						<?php if (isset($_SESSION['username'])): ?>
							...
							<div class="hover-container">
								<p>
								<h2><?php echo htmlspecialchars($_SESSION['nombre'] ?? 'Usuario Desconocido') . ' ' . htmlspecialchars($_SESSION['apellidos'] ?? ''); ?></h2>
	...
	<main class="main-content">
        <h1 class="heading-1">Hola, <?php echo htmlspecialchars($_SESSION['nombre'] ?? 'Usuario Desconocido')?> ! </h1>
