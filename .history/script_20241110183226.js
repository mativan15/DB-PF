...
function displayResults(flights) {
    ...
    flights.forEach(flight => {
        ...
        // Convert the departure date to a proper format (using JS Date object)
        const departureDate = new Date(flight.Fecha_Salida);
        const formattedDepartureDate = departureDate.toLocaleDateString('es-ES'); // format it to the desired pattern
