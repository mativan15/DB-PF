...
function displayResults(flights) {
    ...
    // Confirmar el contenido de `flights` antes de iterar
    console.log("Vuelos encontrados:", flights);

    flights.forEach((flight, index) => {
        console.log(`Mostrando vuelo ${index + 1}:`, flight);  // Para verificar cada vuelo
        ...
        flightDetails.innerHTML = `
            <div class="flight-segment">
                <h3>IDA</h3>
                <p class="route">AQP <span class="arrow">→</span> ${flight.Ciudad_Destino}</p>
