					...
					<div class="iniciar-sesion">
						<div class="text-container">
							<?php if (isset($_SESSION['username'])): ?>
								<h3 class="hover-target">Bienvenido, <?php echo htmlspecialchars($_SESSION['nombre'] ?? 'Usuario Desconocido') . ' ' . htmlspecialchars($_SESSION['apellidos'] ?? ''); ?></h3>
								...
								<div class="hover-container">
									...
									<div id="boton_logout">Cerrar sesión</div>
								</div>
