					...
					<div class="iniciar-sesion">
						<div class="text-container">
							<?php if (isset($_SESSION['username'])): ?>
								<h3>Bienvenido, <?php echo htmlspecialchars($_SESSION['nombre'] ?? 'Usuario Desconocido') . ' ' . htmlspecialchars($_SESSION['apellidos'] ?? ''); ?></h3>
								
								<!-- Botón para abrir el pop-up -->
								<button id="open-popup" class="popup-button">Mostrar Datos</button>
