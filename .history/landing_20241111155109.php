...
<body>
	...
	<section class="banner">
		...
		<?php endif; ?>
			...
			<?php if (isset($_SESSION['username'])): ?>
				<a href="https://localhost/DB-PF/trip.php">Tu viaje comienza aquí</a>
			<?php else: ?>
				<a href="https://localhost/DB-PF/login.php">Inicia sesión para comenzar tu viaje</a>
			<?php endif; ?>
		...
		document.addEventListener('DOMContentLoaded', function() {
			...
			cards.forEach(card => {
				card.addEventListener('click', function() {
					window.location.href = 'https://localhost/DB-PF/trip.php';
				});
			});
		});
