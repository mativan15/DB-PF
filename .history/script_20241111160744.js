...
function searchFlights() {
    ...
    const arrivalDate = document.getElementById('end-date').value;
    console.log(" amhfbjkashfs", destination, departureDate); 
    if (!destination || !departureDate || (Math.ceil((arrivalDate - departureDate) / (1000 * 60 * 60 * 24)))<= 0) {
