					...
					<div class="iniciar-sesion">
						<div class="text-container">
							<?php if (isset($_SESSION['username'])): ?>
								...
								<p class="hover-area"><h3>Bienvenido, <?php echo htmlspecialchars($_SESSION['nombre'] ?? 'Usuario Desconocido') . ' ' . htmlspecialchars(string: $_SESSION['apellidos'] ?? ''); ?></h3> </p>
								<div class="hover-container">
									<p>
									<h2>Bienvenido, <?php echo htmlspecialchars($_SESSION['nombre'] ?? 'Usuario Desconocido') . ' ' . htmlspecialchars(string: $_SESSION['apellidos'] ?? ''); ?></h2>
